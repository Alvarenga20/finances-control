...
const ExpenseTracker: React.FC = () => {
    ...
    return (
        <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors duration-300">
            <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-200">Expense Tracker</h1>
